...
contract ZkMinimalAccountTest is Test {
    ...
    // here minimal account is owned by ANVIL_DEFAULT_ACCOUNT
    ...
    // This test is analogus to the Ethreum MinimalAccountTest
    function testZkOwnerCanExecuteCommands() public {
        // Arrange
        address dest = address(usdc);
        uint256 value = 0; // no ETH value is called
    ...
    function _signTransaction(Transaction memory transaction) internal view returns (Transaction memory) {
        ...
        // but actually scripts doesn't works as intended in zksync, so lets use this one for now
        uint8 v;
        bytes32 r;
        bytes32 s;
        uint256 ANVIL_DEAFULT_PRIVATE_KEY = 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80;
        (v, r, s) = vm.sign(ANVIL_DEAFULT_PRIVATE_KEY, unsignedTransactionHash);
    ...
    function _createUnsignedTransaction(
        ...
        return Transaction({
            txType: transactionType, // doing with txType 113 aka 0x71
