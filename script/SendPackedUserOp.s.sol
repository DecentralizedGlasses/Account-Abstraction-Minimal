...
contract SendPackedUserOp is Script {
    ...
    function generateSignedUserOperation(
        ...
        uint256 nonce = IEntryPoint(config.entryPoint).getNonce(minimalAccount, 0); // fetch the current nonce of the sender
        ...
        returns (PackedUserOperation memory)
    {
        ...
        return PackedUserOperation({
            ...
            signature: hex"" // this is characterstic of unsigned PackedUserOperation
        });
    }
}
